...
import { CustomerQuoteDto } from '../types';
...
export const CustomerQuotationsPage: React.FC = () => {
  ...
  const { data: quotes = [], isLoading } = useQuery({
    ...
    queryFn: () => portalApi.getQuotations(),
  });
  ...
  return (
    <div className="space-y-6 animate-in fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Your Commercial Quotations</h1>
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <span className="font-bold text-slate-900 text-base">Quote #{q.QuotationNumber}</span>
                    <span className="text-xs text-slate-400">v{q.VersionNumber}</span>
                    <span
                  ...
                  <div className="flex items-center space-x-4 text-xs text-slate-500">
                    <span className="flex items-center">
                      ...
                      Valid until {q.ExpirationDate ? new Date(q.ExpirationDate).toLocaleDateString() : 'N/A'}
                    </span>
                    <span>•</span>
                ...
                <div className="flex items-center space-x-6">
                  <div className="text-right">
                    <span className="text-[11px] text-slate-400 block uppercase">Net Total</span>
