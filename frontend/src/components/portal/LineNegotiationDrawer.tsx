...
import { CustomerQuoteLineDto, LineCommentDto } from '../../types';
import { Button } from '../common/Button';
import { LoadingSpinner } from '../common/LoadingSpinner';
import { X, Send, MessageSquare, User, Shield } from 'lucide-react';

interface LineNegotiationDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  line: CustomerQuoteLineDto | null;
...
export const LineNegotiationDrawer: React.FC<LineNegotiationDrawerProps> = ({
  isOpen,
  onClose,
  line,
  comments,
