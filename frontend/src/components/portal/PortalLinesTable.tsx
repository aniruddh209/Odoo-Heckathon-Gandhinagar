...
import { CustomerQuoteLineDto } from '../../types';
import { MessageSquare } from 'lucide-react';

interface PortalLinesTableProps {
  lines: CustomerQuoteLineDto[];
  currency?: string;
  onOpenLineChat: (line: CustomerQuoteLineDto) => void;
                ...
                {canNegotiate && (
                  <td className="py-4 px-4 text-center">
                    <button
                      ...
                      className="inline-flex items-center space-x-1 p-2 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors text-xs font-medium"
