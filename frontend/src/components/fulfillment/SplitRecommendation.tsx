...
import { FulfillmentSplitPreviewDto } from '../../types';
import { Button } from '../common/Button';
import { Building2, Truck, Calendar, CheckCircle, Sliders, AlertCircle } from 'lucide-react';

interface SplitRecommendationProps {
  split: FulfillmentSplitPreviewDto;
  onApplySplit: () => void;
  onManualOverride: () => void;
  isApplying?: boolean;
}

export const SplitRecommendation: React.FC<SplitRecommendationProps> = ({
  split,
  onApplySplit,
  onManualOverride,
  isApplying = false,
