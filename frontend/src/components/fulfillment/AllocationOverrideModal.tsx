...
import { WarehouseDto, ManualAllocationOverrideRequest } from '../../types';
...
interface AllocationOverrideModalProps {
  isOpen: boolean;
  onClose: () => void;
  orderId: string;
  orderNumber: string;
  warehouses: WarehouseDto[];
  onConfirm: (request: ManualAllocationOverrideRequest) => void;
  isSubmitting?: boolean;
}

export const AllocationOverrideModal: React.FC<AllocationOverrideModalProps> = ({
  isOpen,
  onClose,
  orderId,
  orderNumber,
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input
          ...
          onChange={(e) => setAllocatedQuantity(Math.max(1, parseInt(e.target.value) || 1))}
          required
        />
