...
import { RepAnomalyDto } from '../../types';
import { AlertTriangle, TrendingDown, UserX, ArrowUpRight } from 'lucide-react';
import { Button } from '../common/Button';

interface AnomalyAlertCardProps {
  anomaly: RepAnomalyDto;
  onInvestigate?: (repId: string) => void;
}
