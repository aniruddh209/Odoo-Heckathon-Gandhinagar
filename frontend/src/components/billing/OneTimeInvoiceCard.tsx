...
import { FileText, Calendar, DollarSign, CheckCircle2, AlertTriangle, CreditCard } from 'lucide-react';

interface OneTimeInvoiceCardProps {
  invoice: InvoiceDto;
  onRecordPayment?: (invoiceId: string) => void;
  onDownloadPdf?: (invoiceId: string) => void;
}

export const OneTimeInvoiceCard: React.FC<OneTimeInvoiceCardProps> = ({
  invoice,
  onRecordPayment,
  onDownloadPdf,
}) => {
